...
//this actually covers channel AND section setup (some sections follow channel url structure), also includes rightmiddle for nonresolving friendlies
	OAS_listpos = "AdController,AlertsLogo,AutosModule,TravelerModule,TravNarrowModule,BigBanner,Block,CenterBanner,EditLeftHome,LeftBottom,LeftBottom2,Loge,MagSpon2,MasterLogo,RightUndQuotes,RootModule,StoryLogo,ScottradeLogo,TradingCenter1,TradingCenter2,TradingCenter3,TradingCenter4,VertrueModule,x1,x2,x3,x33,x39,x5,MagSpon3,MicrosoftDynamic,RightMiddle,VerisignModule,EditMiddleHome,EditRightHome,MagSpon1,QuietAgent,MerckModule,LexusLogo,DellModule,LufthansaModule,ISSThreatModule,ISSModule,KeyBankModule,x80,x81,x82,x83,x85";
} else if (pageType == "section") {
	OAS_listpos = "AdController,AlertsLogo,AutosModule,TravelerModule,TravNarrowModule,BigBanner,Block,CenterBanner,EditLeftHome,LeftBottom,LeftBottom2,Loge,MagSpon2,MasterLogo,RightUndQuotes,RootModule,StoryLogo,ScottradeLogo,TradingCenter1,TradingCenter2,TradingCenter3,TradingCenter4,VertrueModule,x1,x2,x3,x33,x39,x5,MagSpon3,MicrosoftDynamic,VerisignModule,QuietAgent,MerckModule,LexusLogo,DellModule,LufthansaModule,ISSThreatModule,ISSModule,KeyBankModule,x80,x81,x82,x83,x85";
...
marketsArr[6] = new Array("Options","http://www.forbes.com/options/");
...
function doOmniture() {
	...
	if(welcomeCookie != "undefined") {
		if ((document.cookie.indexOf(welcomeCookie)==-1) && (navigator.userAgent.indexOf("Mozilla")>-1) && (this.location.host.indexOf("forbes.com")!=-1) && (this.location.search.indexOf("partner=yahoo")==-1) && (this.location.search.indexOf("partner=msn")==-1)&& (this.location.search.indexOf("partner=aol")==-1)&& (this.location.search.indexOf("partner=compuserve")==-1)&& (this.location.search.indexOf("partner=netscape")==-1) && (this.location.search.indexOf('nowelcome')==-1)) {
			var tomorrow = new Date();
			...
			if (document.cookie.indexOf(welcomeCookie) != -1){
				...
				this.location='http://www.forbes.com/fdc/welcome_new.shtml';
 			}
		}
	}
	OAS_AD('AdController');
	if(displayedSection != 'Video') {
		...
		//coremetrics
                document.write('<script language="JavaScript1.1" src="http://www.forbes.com/scripts/coremetrics/v40/eluminate.js" type="text/javascript"></script>');
                document.write('<script language="Javascript1.1" src="http://www.forbes.com/scripts/coremetrics/cmdatatagutils.js" type="text/javascript"></script>');
	}
...
function adjustSlide() {
	if (nonav) {
		...
		if (!partners) {
			...
			if(document.getElementById('dynamicAdWinDiv')) document.getElementById('dynamicAdWinDiv').style.top = '162px';
			if(document.getElementById('dynamicAdColDiv')) document.getElementById('dynamicAdColDiv').style.top = '162px';
		} else {
			if(document.getElementById('createAlerts')) document.getElementById('createAlerts').style.top = '241px';
			if(document.getElementById('dynamicAdWinDiv')) document.getElementById('dynamicAdWinDiv').style.top = '202px';
			if(document.getElementById('dynamicAdColDiv')) document.getElementById('dynamicAdColDiv').style.top = '202px';
		}
	}
}
doPartners();
