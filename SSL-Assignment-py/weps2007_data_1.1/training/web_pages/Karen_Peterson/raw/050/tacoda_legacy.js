...
function Tacoda_AMS_DDC(Tacoda_AMS_DDC_img_url, Tacoda_AMS_DDC_js) {
    ...
    document.write('<IMG '+'SRC="' + Tacoda_AMS_DDC_img_url + Tacoda_AMS_DDC_args + '">');
}

//Setup variables from cookies to send to DART
//Split segment cookie and put in OAS_query

document.dartTDataCookie = Tacoda_AMS_DDC_getCookie("TData");
if (document.dartTDataCookie != null && document.dartTDataCookie != "") {  
    document.dartTData = "&AMS="+document.dartTDataCookie;
} else { 
    document.dartTData = "";
}
