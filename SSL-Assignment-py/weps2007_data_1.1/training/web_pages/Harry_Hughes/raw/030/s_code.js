...
s.linkInternalFilters="javascript:,prnewswire.com"
...
s.visitorNamespace="prnewswire"

/* Plugin Config */
s.usePlugins=true
function s_doPlugins(s) {
	/* Add calls to plugins here */
        s.campaign=s.getQueryParam('tc');
        s.setupFormAnalysis();
}
...
function pageName()
{
str = (window.document.URL.toString()).split('com/');
var x = str[1].split('/');
var x1 = "PRNewswire";
var y = '';
   if (x[0] == x1)
	{
		...
		else if (x[1] == 'writingtips.shtml')
			    {
				return('"'+x[0]+' - '+ 'Writing tips"');
			    }
		else if (x[1] == 'faq.shtml')
			    {
				return('"'+x[0]+' - '+ 'FAQs"');
			    }
		else if (x[1] == 'home1.shtml')
			    {
				return('"'+x[0]+' - '+ 'Components of a Press Release"');
		    	}
		else if (x[1] == 'home2.shtml')
			    {
				 return('"'+x[0]+' - '+ 'Six Simple Steps"');
			    }
		else if (x[1] == 'home3.shtml')
				{
					return('"'+x[0]+' - '+ 'Should I Use the Wire"');
				}
		else if (x[1] == 'home4.shtml')
				{
				     return('"'+x[0]+' - '+ 'Special offers"');
				}
		else if (x[1] == 'home5.shtml')
			    {
				return('"'+x[0]+' - '+ 'Increasing Your Online Presence"');
			    }
		else if (x[1] == 'home6.shtml')
			    {
				return('"'+x[0]+' - '+ 'Jump start your PR program"');
			    }
		else if (x[1] == 'distribution.shtml')
				{
					return('"'+x[0]+' - '+ 'Distribution"');
				}
		else if (x[1] == 'signupnow.shtml')
				{
				     return('"'+x[0]+' - '+ 'Request More Information"');
				}
