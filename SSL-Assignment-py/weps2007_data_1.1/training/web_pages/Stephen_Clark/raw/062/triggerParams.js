...
triggerParms["sp"] = 1.5; // sample percentage
...
triggerParms["lfcookie"] = "ForeseeLoyalty_MID_qIF7drmS/b";
triggerParms["ascookie"] = "ForeseeSurveyShown_qIF7drmS/b";
triggerParms["width"] = 450; // survey width
triggerParms["height"] = 500; // survey height
triggerParms["domain"] = ".state.gov"; // domain name
...
triggerParms["dhtmlWidth"] = 420; // welcome page width
triggerParms["dhtmlHeight"] = 290; // welcome page height
triggerParms["dhtmlURL"]= "/scripts/FSRInvite.html";
