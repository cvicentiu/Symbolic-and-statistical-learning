...
var s_account="cnetdev"
var s=s_gi(s_account)
/************************** CONFIG SECTION **************************/
/* You may add or alter any code config here. */
s.dynamicAccountSelection=true
s.dynamicAccountList="cnetcom=www.cnet.com,my.cnet.com;cnetreviews=reviews.cnet.com;cnetnews=news.com.com;cnethelp=help.cnet.com;cnetdownload=www.download.com,video.download.com;cnetshopper=shopper.cnet.com,clearance.cnet.com;cnetcrave=crave.cnet.com;cnetforums=forums.cnet.com;cnetwebware=www.webware.com"
/* E-commerce Config */
s.currencyCode="USD"
...
function s_doPlugins(s) {
	...
	s.prop4=s.getQueryParam('q');
	s.eVar1=s.getQueryParam('tag');
	if(s.events&&s.events.indexOf('event1')!=-1);  // do not add event1 to events... it's already there
	else s.events=s.events?s.events+",event1":"event1";  // add event1 to events list
	s.prop7=s.getDaysSinceLastVisit();
	s.eVar2=s.prop7;
	s.prop9=s.getNewRepeat();
	s.eVar3=s.prop9;
	s.prop10=s.getVisitNum();
	s.eVar5=s.prop10;
	s.eVar4=s.getQueryParam('part');
	s.eVar6=s.getQueryParam('subj');
...
+"/'+(s.ssl?'n':'n')+'.news.com/b/ss/'+s.un+'/1/H.5-pdv-"
