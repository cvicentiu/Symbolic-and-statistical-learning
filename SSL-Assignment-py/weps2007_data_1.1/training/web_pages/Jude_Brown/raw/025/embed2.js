...
if ( plugin ) {
    ...
    document.write(' codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,0,0" width=' + movieWidth + ' height=' + movieHeight + ' ID="Flash">\n');
