...
triggerParms["mid"] = "oIZ5Zts8ddNMUIpMgUFh8w=="; // model instance id
triggerParms["cid"] = "JNFJtQM1QAVdtAU0wwZU4w=="; // customer id
triggerParms["lf"] = 3; // loyalty factor
triggerParms["sp"] = 1; // sample percentage
...
triggerParms["lfcookie"] = "ForeseeLoyalty_MID_oIZ5Zts8dd";
triggerParms["ascookie"] = "ForeseeSurveyShown_oIZ5Zts8dd";
triggerParms["width"] = 500; // survey width
triggerParms["height"] = 500; // survey height
triggerParms["domain"] = ".cbsnews.com"; // domain name
...
triggerParms["dhtmlURL"]= "/common/includes/FSRInvite.html";