...
var _mgn = "t.lawyers.com";
var _vjs="HBX0131.01uCM";
...
function _ER(a,b,c){_hbi.src=_GP()+_gn+"/HG?hc="+_mn+"&hb="+_A(_acct)+"&hec=1&ec=1&err="+((typeof a=="string")?_A(a+"-"+c):"Unknown")}
...
function _LN(a,b,c,d){b=a.href;b+=a.name?a.name:"";c=_LVP(b,"lid");d=_LVP(b,"lpos");return[c,d]}
...
var _f=0,l=_TL(a.protocol),j=k="";if(l!="mailto:"&&l!="javascript:"){j=_LE(a),k=_LD(a);if(_DD(k))a.fn=k;else if(_DD(j))a.el=j}
...
else if(_DD(a.el)){_SV("el",a.el);_f=1}if(_f>0){if(_IL(_hlf)>0&&_f==1){_SV("lf",_hlf);_hfs=1}_TV()}}}
...
_hlf=_ce=_ln=_pl='',_bn=navigator.appName,_bn=(_II(_bn,"Microsoft")?_bn:"MSIE"),_bnN=(_bn=="Netscape"),_bnI=(_bn=="MSIE"),_hck="*AL:"+_als+"; path=/; "+(_D("cpd")&&_D("cpd")!=""?(" domain=."+_D("cpd")+"; "):"")+_ex,_N6=(_bnN&&_bv>4),_I5=((_II(navigator.userAgent,'MSIE 5')>-1)||
