...
function filter_smilies(s) {
	for (var i = 0; i < smilies.length; i++) {
		...
		var replace = '<img src="http://blog.thehill.com/wp-images/smilies/' + smilies[i][1] + '" class="wp-smiley" alt="' + smilies[i][0].replace(/\\/g, '') + '" />';
...
function checkName() {
	...
	if (currentName.value != jalCookie) {
		document.cookie = "jalUserName="+currentName.value+"; expires=Fri, 27 Apr 2007 17:02:58 UTC;"
	}
...
function checkUrl() {
	...
	if (currentName.value != jalCookie) {
		document.cookie = "jalUrl="+currentName.value+"; expires=Fri, 27 Apr 2007 17:02:58 UTC;"
		return;
	}
