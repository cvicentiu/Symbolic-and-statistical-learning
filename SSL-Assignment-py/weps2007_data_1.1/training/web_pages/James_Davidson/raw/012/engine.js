...
menus_array = new Array ('business','databases','design','audiovideo','photography','hardware','homeoffice','microsoft','sysadmin','os','programming','science','security','softwareengineering','web','partnertopics','companies','showcases','fulldesc','reviews');
