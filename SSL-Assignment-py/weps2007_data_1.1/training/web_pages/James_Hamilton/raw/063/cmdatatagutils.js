...
function cmSetProduction(){
	cm_HOST="www58.theatlantic.com/eluminate?"; 
}
...
function cmCreateProductviewTag(productID, productName, categoryID) {
	cmMakeTag(["tid","5","pi","PRODUCT: "+productName+" ("+productID+")","pr",productID,"pm",productName,"cg",categoryID]);
}
...
function cmCreateRegistrationTag(customerID, customerEmail, customerCity,
				...
				subscribe, network_location, subscription_type, date_of_subscription) {
	cmMakeTag(["tid","2","cd",customerID,"em",customerEmail,"ct",customerCity,"sa",customerState,"zp",customerZIP,"nl",newsletterName,"sd",subscribe,"rg11",network_location,"rg12",subscription_type,"rg10",date_of_subscription]);
}
