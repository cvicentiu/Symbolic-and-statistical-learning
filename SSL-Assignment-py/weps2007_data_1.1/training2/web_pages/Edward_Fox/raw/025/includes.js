//This is the DeepMetrix script

var DMNETdomain = "";
var DMNETpage = window.location;
var DMNETversion = "86";
var DMNETsendTo = "//69.59.184.169/dm.gif?";
var DMNETsession;
...
//End DeepMatrix script


	function createlink(linkurl,linktitle)
	{
		document.write("<a href="+linkurl+">"+linktitle+"</a>");
	}


	function createmylink(linkurlnew,linktitlenew,linkclassnew)
	{
		document.write("<a href=" + linkurlnew + "  Class='" + linkclassnew + "'>" + linktitlenew +"</a>");
	}
