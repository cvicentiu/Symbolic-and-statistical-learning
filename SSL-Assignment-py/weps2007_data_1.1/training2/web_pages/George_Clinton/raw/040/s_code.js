...
s.linkInternalFilters="javascript:,theonion"
...
s.useCommerce=true
s.varUsed="eVar16"
s.eventList="event5,event6,event7" //Abandon,Success,Error
s.usePlugins=true
function s_doPlugins(s) {
	if(!s.pageType)
		s.prop2=s.getPageName();
	...
	s.eVar6=s.getQueryParam('search');
	if(s.eVar6)
		s.events="event1";
	s.eVar7=s.eVar6;
	s.setupFormAnalysis();
...
+"/'+(s.ssl?'secure-statistics':'statistics')+'.theonion.com/b/ss/'+s.un+'/1/H.6-pdv-"
