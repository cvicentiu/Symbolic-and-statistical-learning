...
var __utmdn="none";             /*-- (auto|none|domain) set the domain name for cookies --*/
...
// DRS: 2004-04-29: works like __utmLinker, except it returns the value to append
function __utmLinkerTN() {
	var __utmlp,__utmi,__utmi2,__utmta="-",__utmtb="-",__utmtc="-",__utmtz="-";
