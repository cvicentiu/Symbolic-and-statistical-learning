...
function SiteRecruit_PageConfigurationBroker()
{
    ...
    function PageConfigurationBroker_initializeMapping()
    {
        ...
        var x = this.priorities;
                ...
                u[0] = '//((msdn\\.)|(internetbuild34)|(sr-msdn-microsoft\\.))[\\w\\.-]*/(((?!library).*)|(library/en-us/.*))';
                p[0] = '/library/svy/SiteRecruit_PageConfiguration_2944mt1-2943mt32-p10828145mt-3332mt.js';
                x[0] = 0;
                                        
             
                            // http://msdn.microsoft.com/fr-fr
                u[1] = '//((msdn\\.)|(internetbuild34)|(sr-msdn-microsoft\\.))[\\w\\.-]*/fr-fr';
                p[1] = '/library/svy/SiteRecruit_PageConfiguration_fr-fr.js';
                x[1] = 1;
                                        
             
                            // http://msdn.microsoft.com/practices...
                u[2] = '//((msdn\\.)|(internetbuild34)|(sr-msdn-microsoft\\.))[\\w\\.-]*/practices(/|$)';
                p[2] = '/library/svy/SiteRecruit_PageConfiguration_2692mt-2944mt1-2943mt32-3332mt.js';
                x[2] = 1;
                                        
             
                            // http://msdn.microsoft.com/subscriptions/account
                u[3] = '//((msdn\\.)|(internetbuild34)|(sr-msdn-microsoft\\.))[\\w\\.-]*/subscriptions/account';
