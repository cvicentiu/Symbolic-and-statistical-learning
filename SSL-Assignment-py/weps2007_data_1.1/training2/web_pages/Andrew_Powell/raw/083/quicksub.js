...
var txtContentHeader = 'Choose a site:';
...
var q_bgcolor = '#ae001e';
var q_contentfont = 'Verdana';
var q_contentsize = '1';
var q_contentbgcolor = '#ffffff';
...
function quicksub(oLink, originalUrl) {
	...
	if (oTimer) {
        ...
        if (originalUrl.indexOf('http') == -1) {originalUrl='http://blogcritics.org'+originalUrl;}
