...
{ 
	...
	arrayTabNames[1] = 'tvtab';
	arrayTabNames[2] = 'dvdtab';
	arrayTabNames[3] = 'newstab';
	arrayTabNames[4] = 'celebstab';
	arrayTabNames[5] = 'eventstab';
	arrayTabNames[6] = 'fantab';	
	
	arrayhtmlid[0] = 1; //'movies';
	arrayhtmlid[1] = 2; //'tv';
	arrayhtmlid[2] = 3; //'dvd';
	arrayhtmlid[3] = 4; //'news';
	arrayhtmlid[4] = 5; //'celebs';
	arrayhtmlid[5] = 6; //'events';
