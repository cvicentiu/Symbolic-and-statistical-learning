...
var _editor_url = "/htmlarea/"; //"/htmlarea/";                     // URL to htmlarea files
...
/*======================================================*/
/*============Inserted For WinCustomize=================*/
/*======================================================*/
function ValidateCommentFieldAdvanced(ID,bValidateName)
{
...
function editor_insertHTML(objname, str1,str2, reqSel) {
 ...
 // insertHTML for wysiwyg iframe
  ...
  //alert("iframe");
	...
	// We want to replace ' ' with '&nbsp;' so that the spaces will show up in the wysiwyg editor. 
	// This prevents smilies from being appended to the end of URLs
   // var re = /\s/g;
