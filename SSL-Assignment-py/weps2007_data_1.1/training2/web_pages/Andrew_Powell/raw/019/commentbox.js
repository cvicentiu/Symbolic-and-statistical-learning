<!--
//The following code taken from phpBB and modified to suit Shell-Shocked
// Startup variables
var imageTag = false;
...
a_help = "Close all open formatting tags";
s_help = "Submit comment";
f_help = "Clear comment area";
...
function checkForm() {
	...
	if (document.post.comment.value.length < 2) {
