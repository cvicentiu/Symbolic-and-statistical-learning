...
function isReturnFlash(flashname, divname, w, h, bgcolor,flashVars) {
   ...
   //flashHtml += '<embed src="'+flashname+'" quality="high" bgcolor="'+bgcolor+'" width="'+w+'" height="'+h+'" name="flashButton" align="" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"></embed>';
   flashHtml += '</object></div>';
	return flashHtml;
}
