   ...
   function switchToHTMLVersion() {
      // code to switch to accessible HTML version goes here.
   }
...
//toggleDropdowns(isgE('rapportContainer'),'on');
//showFlash();
      shade(false);
...
//toggleDropdowns(isgE('rapportContainer'),'off');
//hideFlash(isgE('rapportContainer'));
      return false;
   }
...
function ismoveFlashSponsors() {
   ...
   function enableFlash() {
    if (isHasFlash && isgE('rapportFlash')) {
      ...
      //isWriteFlash('/flash/rapport.swf?APP_URL=http://kotor.ie.office.aol.com/aol/', 'rapportFlashObj', '100%', '100%', '#EDF8FD');
