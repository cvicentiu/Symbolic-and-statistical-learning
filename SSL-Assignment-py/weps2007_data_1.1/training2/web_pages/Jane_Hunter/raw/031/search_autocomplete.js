...
placeContainer('otherContent');
   // if (isgE('rapportResults') && isgE('rapportResults').style && isgE('rapportResults').innerHTML.length>0) isgE('rapportResults').style.display = 'block'; 
  var text = isgE('searchField').value; 
  if(text!=undefined) text=text.toLowerCase();
    ...
    {isgE('rapportSponsors').style.display = "none"; isgE('rapportSponsors').style.visibility = "hidden"; }
    if(isgE('searchSponsors') && isgE('searchSponsors').style)
    {isgE('searchSponsors').style.display = "none"; isgE('searchSponsors').style.visibility = "hidden"; }
    if(isgE('rapportGoogleOff') && isgE('rapportGoogleOff').style)
    {isgE('rapportGoogleOff').style.display = "none"; isgE('rapportGoogleOff').style.visibility = "hidden"; }
    if(isgE('rapportGoogle') && isgE('rapportGoogle').style)
    {isgE('rapportGoogle').style.display = "none"; isgE('rapportGoogle').style.visibility = "hidden"; }
    if(isgE('rapportAdServer') && isgE('rapportAdServer').style)
    {isgE('rapportAdServer').style.display = "none";isgE('rapportAdServer').style.visibility = "hidden";}
...
if(document.all)if (isgE('DL_Container')) isgE('DL_Container').style.zIndex = '0';
 ...
 if(document.all)if (isgE('controlsContainer2')) isgE('controlsContainer2').style.zIndex = '0';
   if (isHasFlash && isgE('rapportFlash')) {
     ...
     ishideSuggestion();     placeContainer('rapportAutoClose');
     issetSearchFieldFocus();     if(isgE('sort') && isgE('sort').style && isgE('sort').style.visibility == "hidden") isgE('sort').style.visibility = "visible"
