...
/*
function openShareIt(response) {
		
	enc = response.documentElement.getElementsByTagName("encodedQueryString");

	if(enc != null) {
		var sendUrl = "http://localhost:8080/instore/WishList" + enc.item(0).firstChild.nodeValue;
		win = window.open("about:blank", 'win',  'height=200');
		win.focus();
		win.document.write("<html><body><a href='mailto: friend@aol.com?body=Check out my wishlist here : "+sendUrl+"'>Send your friend your Wishlist</a><br/>URL is: "+sendUrl+"</body></html>");
	}
	else {
...
//					openShareIt(xmlhttp.responseXML);		
					if (shareType == "email"){
