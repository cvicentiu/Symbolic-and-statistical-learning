...
function lycos_draw_toolbar() {
	...
	toolbar_html += 
	    '<a href="http://lt.angelfire.com/af_toolbar/build/_h_/'+this.lycos_ad_www_server+'/campaigns/landing/toolbar.tmpl" target="_top">Build a Site</a>&nbsp;</td>';
    } else {
	toolbar_html += 
	    '<a href="http://lt.angelfire.com/af_toolbar/edit/_h_/'+this.lycos_ad_www_server+'/build/index.tmpl" target="_top">Edit your Site</a>&nbsp;</td>';
    }
    toolbar_html +=
