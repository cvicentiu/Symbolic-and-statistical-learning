...
function writeWMP(DivID,mediaUrl) {
  ...
  '<embed type="application/x-mplayer2" pluginspage="http://www.microsoft.com/Windows/MediaPlayer/" src="'+mediaUrl+'" width="515" height="45" autostart="1" showcontrols="1" volume="-300">'+
  '<\/embed>'+
  '<\/object>';
}
