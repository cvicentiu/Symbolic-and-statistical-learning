...
function cm_makeObj(obj,nest,o,doc){ //Changed in v4.05
  ...
  if(!this.evnt) return cm_message('If you are using Netscape please enable support for Stylesheets, or else disable JavaScript.\n\nTry looking in Edit | Preferences | Advanced.')
...
//  if(!frame) frame = top //changed JCC 
  if(!frame) frame = self //original JCC 
...
makeCM.prototype.makeObjects=function(nowrite,fromframe){ //Changed v4.06
  ...
  if(fromframe){
    ...
    this.deftarget=top // changed JCC
//    this.deftarget=self // original JCC
  }
  if(!nowrite){
...
//		if(String(targ)=="undefined" || targ=="" || targ==0 || targ=="_top"){ // changed JCC
		if(String(targ)=="undefined" || targ=="" || targ==0 || targ=="_self"){ // original JCC
