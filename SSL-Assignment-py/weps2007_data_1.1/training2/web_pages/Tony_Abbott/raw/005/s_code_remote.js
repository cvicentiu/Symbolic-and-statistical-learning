/************************ ADDITIONAL FEATURES ************************
     Dynamic Account Selection		23-Feb-05 v1.4	SMH
     Plugins
*/
/************************** CONFIG SECTION **************************/
...
var s_account="f2nsmh"
var s_dynamicAccountSelection=true
var s_dynamicAccountList="devf2nsmh=127.0.0.1,localhost,"+
"theage.web.fairfax.com.au,rugbyheaven.web.fairfax.com.au,theage.web.fairfax.com.au,"+
"172.16.,smh.web.fairfax.com.au,dev.reg.,dev.realfooty.,dev.rugbyheaven.,stage.,ssotest.,proof.,orcdev1.";
/* E-commerce Config */
var s_eVarCFG=""
...
var s_linkInternalFilters="javascript:smh.com.au,sunherald.com.au"
var s_linkLeaveQueryString=false
var s_linkTrackVars="None"
var s_linkTrackEvents="None"
var s_searchEngineList="news.google.com.au=nat:newsgoogleau,google.com.au=nat:googleau,news.google.com=nat:newsgooglecom,google.com=nat:googlecom,search.ninemsn.com.au=nat:ninemsn,au.search.yahoo.com=nat:yahooau,sensis.com.au=nat:sensis"
/* Plugin Config */
...
s_events = s_events + "event5";
// JH: profile cookies
var p_cookieString = document.cookie || "";
var p_cookies = p_cookieString.split(/\s*;\s*/);
var s_prop4="No cookie", s_prop5="No cookie", s_prop6="No cookie", s_prop7="No cookie", s_prop8="No cookie";
for (var i in p_cookies) {
    var cookie = p_cookies[i];
    var dough = cookie.split(/\s*=\s*/);
    switch(dough[0]) {
        case "prAB": s_prop4 = dough[1] || "No cookie data"; break;
        case "prG":  s_prop5 = dough[1] || "No cookie data"; break;
        case "prL":  s_prop6 = dough[1] || "No cookie data"; break;
        case "prR":  s_prop7 = dough[1] || "No cookie data"; break;
        case "prPS": s_prop8 = dough[1] || "No cookie data"; break;
        default: break;
    }
}

/*Setting demographic data*/
var lookup_s_prop4 = new Array();
lookup_s_prop4["1"]="Under 18";
lookup_s_prop4["2"]="18 - 24";
lookup_s_prop4["3"]="25 - 29";
lookup_s_prop4["4"]="30 - 34";
lookup_s_prop4["5"]="35 - 39";
lookup_s_prop4["6"]="40 - 44";
lookup_s_prop4["7"]="45 - 49";
lookup_s_prop4["8"]="50 - 54";
lookup_s_prop4["9"]="55 - 59";
lookup_s_prop4["10"]="60 - 64";
lookup_s_prop4["11"]="65 and over";
var lookup_s_prop5 = new Array();
lookup_s_prop5["0"]="Male";
lookup_s_prop5["1"]="Female";
lookup_s_prop5["2"]="Other";
var lookup_s_prop6 = new Array();
lookup_s_prop6["0"]="Unspecified";
lookup_s_prop6["1"]="International";
lookup_s_prop6["2"]="ACT";
lookup_s_prop6["3"]="NSW";
lookup_s_prop6["4"]="NT";
lookup_s_prop6["5"]="QLD";
lookup_s_prop6["6"]="SA";
lookup_s_prop6["7"]="TAS";
lookup_s_prop6["8"]="VIC";
lookup_s_prop6["9"]="WA";
var lookup_s_prop7 = new Array();
lookup_s_prop7["R"]="Registered";
lookup_s_prop7["U"]="Not Registered";
var lookup_s_prop8 = new Array();
lookup_s_prop8["0"]="no sub";
lookup_s_prop8["1"]="SMH sub";
lookup_s_prop8["2"]="Age sub";
lookup_s_prop8["3"]="SMH and Age sub";
var ts_prop4 = lookup_s_prop4[s_prop4];
if(ts_prop4 != null) {
	s_prop4 = ts_prop4;
}
var ts_prop5 = lookup_s_prop5[s_prop5];
if(ts_prop5 != null) {
	s_prop5 = ts_prop5;
}
var ts_prop6 = lookup_s_prop6[s_prop6];
if(ts_prop6 != null) {
	s_prop6 = ts_prop6;
}
var ts_prop7 = lookup_s_prop7[s_prop7];
if(ts_prop7 != null) {
	s_prop7 = ts_prop7;
}
var ts_prop8 = lookup_s_prop8[s_prop8];
if(ts_prop8 != null) {
	s_prop8 = ts_prop8;
}
/*end setting demographic data*/

function s_doPlugins() {
	s_server=window.location.host;

	s_vp_getCGI("s_eVar2","from");
	s_eVar2 = s_vp_getValue("s_eVar2");

	if(!(window.s_prop10 && s_prop10.length > 0) && (window.pCid && window.pCid.length>0)) {
		if(pCid.toLowerCase().indexOf("<param name=") != -1) {
			s_prop10 = "";  // Assume URL if we can't make this work
			var tempVar = pCid.substring(pCid.indexOf("value="));
			var quotes = "\"";
			if(tempVar.indexOf("=\'")!=-1)  quotes="'";
			if(tempVar.split) {
				var tempVar2 = tempVar.split(quotes);
				if(tempVar2.length>=2 && tempVar2[1].length > 5) s_prop10 = tempVar2[1];
			}
		} else {
			var appendCID = "";
			if(s_eVar2 == "rss") {
			...
			s_prop10 = pCid+appendCID;
		}
	}

	s_vp_getCGI("s_eVar1","q");
	s_vp_getCGI("s_campaign","s_cid");
	s_vp_getCGI("s_eVar10", "s_rid");
	s_vp_getCGI('s_eVar11','sssdmh');
	s_vp_setNatSearchEngineCode("s_campaign",s_searchEngineList); 
}

/************************** PLUGINS SECTION *************************/
/* You may insert any plugins you wish to use here.                 */
/*
 * Plugin: Set campaign based on referring Domain
 *  This must be called after getCGI, or after the s_campaign variable is set
 */
function s_vp_setNatSearchEngineCode(vs,ful){
	if(!s_vp_getValue(vs))s_vpr(vs,s_getRef());function s_getRef(){
	var rt=(s_gg('referrer'))?s_gg('referrer'):s_gtfs().document.referrer;
	var irf=s_pt(ful,',',s_cse,rt);if(irf){return irf;}return '';}function
	s_cse(t,k){var t1='',t2='';if(t){y=t.indexOf('=');if(y>-1){t1=t.substring
	(0,y);t2=t.substring(y+1,t.length);if(t2=='')t2=t1;}else{t1=t;t2=t;}if
	(k.indexOf(t1)>-1)return t2;return'';}return'';}}
/*
