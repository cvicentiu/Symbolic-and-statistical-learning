//*******************************************************************************
//**************************** DoubleClick SiteCatalyst Tag **********************
//*******************************************************************************
// NOTE: as of 10/31/2005, SiteAdvance is no longer used.

function analyticsTrackingEncyHome() {
  createTagForPage("ency", "ency home", "home")
}

function analyticsTrackingEncySearchResults() {
  createTagForPage("ency", "ency search results", "search");
}

function analyticsTrackingEncyBrowse() {
  createTagForPage("ency", "ency browse", "browse");
}

function analyticsTrackingEncyDocView() {
  createTagForPage("ency", "ency document", "document");
}



function createTagForPage(sectionName, pageName, pgUrlOverride) {
	createSiteCatalystJavascriptForPage(sectionName, pageName, pgUrlOverride);
}




function createSiteCatalystJavascriptForPage(sectionName, pageName, pgUrlOverride) {

  //alert("Entered createSiteCatalystJavascriptForPage()  sectionName=|" + sectionName + "| pageName=|" + pageName + "| pgUrlOverride=|" + pgUrlOverride + "|");

  // --------------------------------------------------------------------------------
  // s_account variable (Report Suite)
  //var s_account="highbeamencyclo";	// This suite is not being used.
 // var s_account="highbeamdev";			// This suite is to be used on dev/qa environments.
  var s_account="highbeamcom";			// This suite is to be used on stage/production environments.
  ...
  // --------------------------------------------------------------------------------
  // Write primary variables script

  s.pageName=pageName
  s.server=""
  s.channel=sectionName
  s.pageType=""
  s.prop1=""
  s.prop2=""
  s.prop3=""
  ...
  s.linkInternalFilters="javascript:,encyclopedia.com"

  //if (pgUrlOverride.length > 0) {
  //	  s.pageURL = pgUrlOverride;
  //}
...
} // createSiteCatalystJavascriptForPage()
