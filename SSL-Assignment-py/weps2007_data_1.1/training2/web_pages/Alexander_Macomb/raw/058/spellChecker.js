...
function spellChecker( textObject ) {
	...
	this.popUpUrl = '/spellchecker/spellchecker.html';
	this.popUpName = 'spellchecker';
	this.popUpProps = "menu=no,width=440,height=350,top=70,left=120,resizable=yes,status=yes";
	//this.spellCheckScript = '/spellchecker/server-scripts/spellchecker.php';
	this.spellCheckScript = '/spellchecker/server-scripts/spellchecker.html';
...
function terminateSpell() {
	...
	//	msg += "\n";
		var div_name;
		if (this.textArea.id){
			div_name = this.textArea.id+ '_div';
		}else{
			div_name = this.textArea.name+ '_div';
		}
