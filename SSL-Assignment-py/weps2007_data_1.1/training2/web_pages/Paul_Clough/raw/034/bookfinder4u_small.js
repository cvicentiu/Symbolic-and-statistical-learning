...
{ 
  		bookmarkurl="http://www.bookfinder4u.com"
		bookmarktitle="BookFinder4U.com - Find the Lowest Book Price For You"
  window.external.AddFavorite(bookmarkurl,bookmarktitle)
}
else if (bro == "Opera")
{
document.getElementById("status5").innerHTML='Like our free service? Please bookmark this site to support us.<br>To bookmark this site, click <b><font color="#FF3300">Bookmarks | BookMark page<br></font></b>Or simply press <b><font color="#FF3300">Ctrl+T</font></b><font color="#FF3300">.</font><br><br><br> '	
}
...
function submit_info(page_url)
{
var msg = escape(document.forms.suggestion_form.suggestion_msg.value)
var refer = escape(page_url)
MM_openBrWindow('/suggestion_box.aspx?msg=' + msg + '&refer=' + refer,'','scrollbars=yes,width=600,height=300')
